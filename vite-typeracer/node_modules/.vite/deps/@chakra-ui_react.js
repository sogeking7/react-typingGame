...
var DescendantsManager = class {
  constructor() {
    ...
    __publicField(this, "indexOf", (node2) => {
      ...
      if (!node2)
        return -1;
      return ((_a = this.descendants.get(node2)) == null ? void 0 : _a.index) ?? -1;
    });
...
var variants = {
  exit: ({
    ...
    transition: (transition2 == null ? void 0 : transition2.exit) ?? withDelay.exit(defaultTransitions2.exit, delay2)
  }),
  enter: ({
    animateOpacity,
    endingHeight,
    ...
    transition: (transition2 == null ? void 0 : transition2.enter) ?? withDelay.enter(defaultTransitions2.enter, delay2)
  })
};
...
function useCounter(props = {}) {
  ...
  const [valueState, setValue] = (0, import_react99.useState)(() => {
    if (defaultValue == null)
      return "";
    return cast2(defaultValue, stepProp, precisionProp) ?? "";
  });
  ...
  const reset = (0, import_react99.useCallback)(() => {
    ...
    if (defaultValue == null) {
      ...
      next = cast2(defaultValue, stepProp, precisionProp) ?? min2;
    }
    update(next);
  }, [defaultValue, precisionProp, stepProp, update, min2]);
  const castValue = (0, import_react99.useCallback)((value2) => {
    const nextValue = cast2(value2, stepProp, precision) ?? min2;
    update(nextValue);
...
function useEditable(props = {}) {
  ...
  const onBlur3 = (0, import_react104.useCallback)((event) => {
    ...
    const relatedTarget = event.relatedTarget ?? doc2.activeElement;
...
function useEventListener2(event, handler, env3, options) {
  ...
  (0, import_react106.useEffect)(() => {
    const node2 = runIfFn(env3) ?? document;
    if (!handler) {
      return;
    }
    node2.addEventListener(event, listener, options);
...
var getBreakpoint = (theme2, value) => {
  var _a;
  return ((_a = theme2 == null ? void 0 : theme2.breakpoints) == null ? void 0 : _a[value]) ?? value;
};
...
function useBreakpoint(arg) {
  var _a;
  const opts = isObject3(arg) ? arg : { fallback: arg ?? "base" };
  const theme2 = useTheme();
  ...
  return ((_a = breakpoints2[index2]) == null ? void 0 : _a.breakpoint) ?? opts.fallback;
}
...
function getOwnerWindow2(node2) {
  var _a;
  return ((_a = getOwnerDocument2(node2)) == null ? void 0 : _a.defaultView) ?? window;
}
...
function getDrawerPlacement(placement, dir) {
  ...
  if (!placement)
    return;
  return ((_a = placementMap2[placement]) == null ? void 0 : _a[dir]) ?? placement;
}
...
function useAttributeObserver(ref, attributes, fn2, enabled) {
  (0, import_react175.useEffect)(() => {
    if (!ref.current || !enabled)
      return;
    const win2 = ref.current.ownerDocument.defaultView ?? window;
...
function useNumberInput(props = {}) {
  ...
  const parse4 = (0, import_react174.useCallback)((value) => (parseValue == null ? void 0 : parseValue(value)) ?? value, [parseValue]);
  const format2 = (0, import_react174.useCallback)((value) => ((formatValue == null ? void 0 : formatValue(value)) ?? value).toString(), [formatValue]);
  useUpdateEffect(() => {
  ...
  useEventListener(() => inputRef.current, "wheel", (event) => {
    var _a;
    const doc2 = ((_a = inputRef.current) == null ? void 0 : _a.ownerDocument) ?? document;
  ...
  const getInputProps = (0, import_react174.useCallback)((props2 = {}, ref = null) => ({
    ...
    "aria-invalid": ariaAttr3(isInvalid ?? counter2.isOutOfRange),
...
var NumberDecrementStepper = forwardRef(function NumberDecrementStepper2(props, ref) {
  ...
  }, props.children ?? import_react172.default.createElement(TriangleDownIcon, null));
});
...
var NumberIncrementStepper = forwardRef(function NumberIncrementStepper2(props, ref) {
  ...
  return import_react172.default.createElement(StyledStepper, {
    ...increment,
    __css: styles.stepper
  }, props.children ?? import_react172.default.createElement(TriangleUpIcon, null));
});
...
var CircularProgress = forwardRef((props, ref) => {
  ...
  const determinant = isIndeterminate ? void 0 : (progress22.percent ?? 0) * 2.64;
...
function useRadio(props = {}) {
  ...
  id3 = idProp ?? id3;
  const isDisabled2 = isDisabledProp ?? (formControl == null ? void 0 : formControl.isDisabled);
...
function trackMutation(el, cb) {
  ...
  if (!el || !el.parentElement)
    return;
  const win2 = ((_a = el.ownerDocument) == null ? void 0 : _a.defaultView) ?? window;
...
function useRangeSlider(props) {
  ...
  const getThumbProps = (0, import_react200.useCallback)((props2, ref = null) => {
    ...
    return {
      ...
      "aria-valuetext": (getAriaValueText == null ? void 0 : getAriaValueText(valueAtIndex)) ?? (ariaValueText == null ? void 0 : ariaValueText[index2]),
...
var RangeSlider = forwardRef(function RangeSlider2(props, ref) {
  ...
  const ctx = (0, import_react199.useMemo)(() => ({ ...context, name: sliderProps.name }), [context, sliderProps.name]);
...
var Slider = forwardRef((props, ref) => {
  ...
  return import_react198.default.createElement(SliderProvider, {
    ...
    ...rootProps,
    className: cx20("chakra-slider", sliderProps.className),
    __css: styles.container
  }, sliderProps.children, import_react198.default.createElement("input", {
    ...inputProps
  }))));
});
...
function useTabs(props) {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react208.useState)(defaultIndex ?? 0);
...
function createToastFn(dir, defaultOptions3) {
  const normalizeToastOptions = (options) => ({
    ...defaultOptions3,
    ...options,
    position: getToastPlacement((options == null ? void 0 : options.position) ?? (defaultOptions3 == null ? void 0 : defaultOptions3.position), dir)
  });
  const toast = (options) => {
